...
class UploadTests: XCTestCase {
    ...
    func testUploadFile500KB() {
        uploadTemplateFileBy(500 * 1024)
    }
    
    func testUploadFile600KB() {
        uploadTemplateFileBy(600 * 1024)
    }
...
extension UploadTests {
    ...
    func uploadTemplateFileBy(fileSize: Int) {
        let tempFileURL = generateTempFileBy(fileSize)
        let tempfileKey = tempFileURL.lastPathComponent!  // such as 'xxx/xxx/xxx.jpg'
